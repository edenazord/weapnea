                ...
                <div className={isMobile ? 'col-span-1' : 'md:col-span-2'}>
                    ...
                    <Card className="overflow-hidden shadow-lg">
                        ...
                        <div className={`${isMobile ? 'p-4' : 'p-6 md:p-8'}`}>
                                                                                                                {/* Organizzatore + co-organizzatori sulla stessa riga */}
                                                                                                                {(organizerId || event.organizer_name) && (
                                                                                                                    <div className="mb-3 flex flex-wrap items-center gap-x-3 gap-y-2">
                                                                                                                        {/* Organizzatore principale */}
                                                                                                                        {organizerId ? (
                                                                                                                            <Link to={(event as any).organizer_public_enabled && (event as any).organizer_public_slug ? `/profile/${(event as any).organizer_public_slug}` : `/profile/id/${organizerId}`} className="flex items-center gap-2 group">
                                                                                                                        ...
                                                                                                                        {/* Co-organizzatori sulla stessa riga */}
                                                                                                                        {event.coorganizers && Array.isArray(event.coorganizers) && event.coorganizers.length > 0 && (
                                                                                                                            <>
                                                                                                                                <span className="text-xs text-gray-400">{t('events.with_coorganizers', 'con')}</span>
                    ...
                    {/* Commenti – visibili a tutti, possono scrivere tutti gli utenti loggati */}
                    {event.id && (
                      <div className="mt-8">
                        <Comments eventId={event.id} canComment={!!user} />
                      </div>
                    )}
                </div>
                                ...
                                <div className="flex items-start">
                                    ...
                                    <div>
                                        ...
                                        <p className={`text-gray-600 ${isMobile ? 'text-sm' : ''}`}>{event.nation}</p>
                                                ...
                                                {/* Link gruppo WhatsApp — visibile solo agli iscritti */}
                                                {isParticipant && (event as any).whatsapp_group_url && (
                                                    <a
                                                        href={(event as any).whatsapp_group_url}
                                                        target="_blank"
                                                        rel="noopener noreferrer"
                                                        className="w-full mt-3 inline-flex items-center justify-center gap-2 px-4 py-2 rounded-md bg-[#25D366] hover:bg-[#1DA851] text-white font-medium transition-colors"
                                                    >
                                                        ...
                                                        {t('events.whatsapp_group', 'Gruppo WhatsApp')}
                                                    </a>
                                                )}
                    </Card>
